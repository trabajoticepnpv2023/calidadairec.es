...
/*  DOCUMENTATION
    ...
    $name is a 'block_monitorc_heading',
    $visiblename is get_string('settings_heading', 'block_monitorc'), a string heading for your settings,
    $description is get_string('settings_content', 'block_monitorc'), which is another string, this is a shorttext displayed
...
*/
$settings->add(new admin_setting_heading('block_monitorc_heading', 
                                          get_string('settings_heading', 'block_monitorc'),
                                          get_string('settings_content', 'block_monitorc')));

$settings->add(new admin_setting_configtext('block_monitorc/Label',
                                             get_string('label', 'block_monitorc'),
                                             get_string('label_desc', 'block_monitorc'), '', PARAM_TEXT));
